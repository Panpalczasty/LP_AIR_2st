##################################################################################
##                                                                              ##
##  servo_vc+rtcon_usb2_x64.TMF  - template makefile                            ##
##                      Builds executable DLL format files for                  ##
##                      W7 x64  environments                                    ##
##                                                                              ##
##  Packages:   SERVO                                                           ##
##                                                                              ##
##  MATLAB versions:             R2014a 64 bit                                  ##
##  Simulink versions:                                                          ##
##  RTW versions:                                                               ##
##                                                                              ##
##  Visual C/C++ versions:                                                      ##
##                                                                              ##
##  (C) COPYRIGHT 2013 InTeCo Inc., 2K, KH                                      ##
##                                                                              ##
##     05.10.2015 = tuning for R2014a x64 2K!! KH                               ##
##     17.04.2013 = tuning for R2014a x64 2K KH                                 ##
##     16.10.2008                                                               ##
##        EXT_LIB = wsock32.lib changed to EXT_LIB = ws2_32.lib                 ##
##                                                                              ##
##################################################################################
...
HOST            = PC
BUILD           = yes
SYS_TARGET_FILE = rtcon_servo_usb2.tlc
...
MODEL                = nasz_usb_servo_wzorzec
MODULES              = nasz_usb_servo_wzorzec_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             = nasz_usb_servo_wzorzec.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = E:\MATLAB_WORK\wt_11-30_og\Wzorzec
S_FUNCTIONS          = rtiostream_utils.c rtdacusb2_servo_dd.c
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
NCSTATES             = 2
BUILDARGS            =  MAT_FILE=1 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DON_TARGET_WAIT_FOR_START=0"
MULTITASKING         = 0
EXT_MODE             = 1
...
SHARED_LIB           = 
TARGET_LANG_EXT      = c
MEX_OPT_FILE         = -f "C:\Program Files\MATLAB\R2015aSP1\bin\win64\mexopts\winsdk-7.1_c.xml"
VISUAL_VER           = 7.1SDK
OPTIMIZATION_FLAGS   = 
ADDITIONAL_LDFLAGS   = 
...
MODELLIB                  = nasz_usb_servo_wzorzeclib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = nasz_usb_servo_wzorzec_ref.rsp
MODELREF_INC_PATH         = 
...
# RT-CON definitions
#
RTCON_DIR = $(MATLAB_ROOT)\toolbox\Servo
RTCON_DIR_C = $(RTCON_DIR)\blocks\c
...
SRCS = $(RTCON_SRCS) $(REQ_SRCS) $(USER_SRCS) $(S_FUNCTIONS)
...
$(PRODUCT) : $(OBJS) $(SHARED_LIB) $(LIBS) $(MODELREF_LINK_LIBS)
	...
	@cmd /C "echo S_FUNCTIONS_LIB: $(S_FUNCTIONS_LIB)"
